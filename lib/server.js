...
NodeTunes.prototype.start = function(callback) {
  ...
  portastic.find({
    ...
    var externalPort = ports[0];
    var internalPort = ports[1];
    ...
    this.netServer = net.createServer(this.rtspServer.connectHandler.bind(this.rtspServer)).listen(internalPort, function() {

      var ad = mdns.createAdvertisement(mdns.tcp('raop'), externalPort, {
